...
public class FollowersListActivity_ViewBinding implements Unbinder {
  private FollowersListActivity target;

  @UiThread
  public FollowersListActivity_ViewBinding(FollowersListActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public FollowersListActivity_ViewBinding(FollowersListActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FollowersListActivity target = this.target;
