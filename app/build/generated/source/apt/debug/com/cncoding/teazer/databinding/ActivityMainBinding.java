package com.cncoding.teazer.databinding;
...
public class ActivityMainBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.welcome_video, 1);
        sViewsWithIds.put(R.id.main_fragment_container, 2);
        sViewsWithIds.put(R.id.up_btn, 3);
        sViewsWithIds.put(R.id.reveal_layout, 4);
    ...
    public final android.widget.FrameLayout revealLayout;
    public final android.support.v7.widget.AppCompatImageView upBtn;
    public final android.view.TextureView welcomeVideo;
    // variables
    // values
    // listeners
    ...
    public ActivityMainBinding(android.databinding.DataBindingComponent bindingComponent, View root) {
        ...
        this.mainFragmentContainer = (android.widget.FrameLayout) bindings[2];
        this.progressBar = (android.widget.ProgressBar) bindings[5];
        this.revealLayout = (android.widget.FrameLayout) bindings[4];
        this.upBtn = (android.support.v7.widget.AppCompatImageView) bindings[3];
        this.welcomeVideo = (android.view.TextureView) bindings[1];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public static ActivityMainBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot, android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityMainBinding>inflate(inflater, com.cncoding.teazer.R.layout.activity_main, root, attachToRoot, bindingComponent);
    }
    ...
    public static ActivityMainBinding inflate(android.view.LayoutInflater inflater, android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.cncoding.teazer.R.layout.activity_main, null, false), bindingComponent);
    }
