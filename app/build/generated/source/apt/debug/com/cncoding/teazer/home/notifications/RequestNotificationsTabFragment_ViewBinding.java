...
public class RequestNotificationsTabFragment_ViewBinding implements Unbinder {
  private RequestNotificationsTabFragment target;

  @UiThread
  public RequestNotificationsTabFragment_ViewBinding(RequestNotificationsTabFragment target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RequestNotificationsTabFragment target = this.target;
