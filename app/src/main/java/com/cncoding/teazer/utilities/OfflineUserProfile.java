...
public class OfflineUserProfile {
    ...
    public static void saveUserProfileOffline(UserProfile userProfile, Context context) {
        new OfflineUserProfile(context)
                ...
                .setAccountType(userProfile.getAccountType())
                .setCreatedAt(userProfile.getCreatedAt())
                .setUpdatedAt(userProfile.getUpdatedAt())
                .setHasProfileMedia(userProfile.hasProfileMedia())
                .setProfileMedia(userProfile.getProfileMedia())
                .setCategories(userProfile.getCategories())
