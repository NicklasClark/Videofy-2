...
public class Annotations {
    ...
    /**
     * Field Validation types for any AuthFragment extending {@link BaseAuthFragment}.
     */
    ...
    public static final int CALL_GET_USER_INTERESTS_AND_TRENDING_CATEGORIES = 901;
    ...
    @IntDef({NO_CALL,
            ...
            CALL_GET_USER_INTERESTS_AND_TRENDING_CATEGORIES,
