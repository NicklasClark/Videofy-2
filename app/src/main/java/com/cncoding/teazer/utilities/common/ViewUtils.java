...
//                        activity.getResources().getIdentifier("status_bar_height", "dimen", "android")));
    ...
    public static void performVideoUpload(Context packageContext, UploadParams uploadParams) {
        SharedPrefs.saveVideoUploadSession(packageContext, uploadParams);
...
//        config.setMaskColor(Color.parseColor("#CC000000"));
    ...
    @Contract(pure = true) @DrawableRes public static int getGenderSpecificDpSmall(@Annotations.Gender int gender) {
        return gender == Annotations.MALE ?
                R.drawable.ic_user_male_dp_small :
                R.drawable.ic_user_female_dp;
    }

    @Contract(pure = true) @DrawableRes public static int getGenderSpecificDpLarge(@Annotations.Gender int gender) {
        return gender == Annotations.MALE ?
