 ...
 * specified {@link HomeScreenPostAdapterListener}.
 */
public class HomeScreenPostsAdapter extends RecyclerView.Adapter<HomeScreenPostsAdapter.ViewHolder> {
    ...
    private HomeScreenPostAdapterListener listener;
    private final List<PostDetails> posts;
    private Context context;

    HomeScreenPostsAdapter(List<PostDetails> posts, Context context) {
        this.posts = posts;
        ...
        if (listener != null) {
            View.OnClickListener viewPostDetails = new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    listener.onHomeScreenPostInteraction(ACTION_VIEW_POST, postDetails);
                }
            };
            View.OnClickListener viewProfile = new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    listener.onHomeScreenPostInteraction(ACTION_VIEW_PROFILE, postDetails);
                }
            };
...
//        @BindView(R.id.home_screen_post_layout) RelativeLayout layout;
    ...
    public void onAttachedToRecyclerView(RecyclerView recyclerView) {
        ...
        if (context instanceof HomeScreenPostAdapterListener) {
            listener = (HomeScreenPostAdapterListener) context;
        } else {
            throw new RuntimeException(context.toString()
                    + " must implement HomeScreenPostAdapterListener");
        }
    }
    ...
    interface HomeScreenPostAdapterListener {
