...
public class PostDetailsActivity extends BaseBottomBarActivity implements MediaControllerView.MediaPlayerControlListener,
...
//    @BindView(R.id.app_bar) AppBarLayout appBar;
    ...
    private ArrayList<Pojos.Post.PostReaction> postReactions;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setCustomContentView(getLayoutInflater().inflate(R.layout.activity_post_details, null));
        ButterKnife.bind(this);
        setupActionBar(this, toolbar, true);
        initVariables();
        prepareMediaPlayer();
...
//        postList = new Pojos.Post.PostList(false, new ArrayList<PostDetails>());
...
//        postDetails = bundle.getParcelable(EXTRAS);
    ...
    private void prepareMediaPlayer() {
        ...
        try {
            mediaPlayer.setDataSource(this, Uri.parse(postDetails.getMedias().get(0).getMediaUrl()));
        ...
        mediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mediaPlayer) {
                progressBar.startAnimation(AnimationUtils.loadAnimation(PostDetailsActivity.this, R.anim.zoom_out));
                ...
                if (postDetails != null) {
                    controller = new MediaControllerView.Builder(PostDetailsActivity.this, PostDetailsActivity.this)
...
//                                No more reactions available. So populating the reactions in the recyclerView.
                    ...
                    public void onFailure(Call<Pojos.Post.PostReactionsList> call, Throwable t) {
                        ViewUtils.makeSnackbarWithBottomMargin(PostDetailsActivity.this, recyclerView, t.getMessage());
                    }
                });
    }
    ...
    private void populateRecyclerView(ArrayList<Pojos.Post.PostReaction> postReactions) {
        ...
        recyclerView.setAdapter(new PostReactionAdapter(postReactions, this));
    }
    ...
    private void populateDummyReactions() {
        ...
        PostReactionAdapter adapter = new PostReactionAdapter(postReactions, this);
    ...
    private class OnDismissListener implements PopupMenu.OnDismissListener {
        ...
        public void onDismiss(PopupMenu menu) {
            Toast.makeText(PostDetailsActivity.this, "Popup Menu is dismissed", Toast.LENGTH_SHORT).show();
        }
        ...
        public boolean onMenuItemClick(MenuItem item) {
            switch (item.getItemId()) {
                case R.id.action_hide:
                    Toast.makeText(PostDetailsActivity.this, "Hide", Toast.LENGTH_SHORT).show();
                    return true;
                case R.id.action_delete:
                    Toast.makeText(PostDetailsActivity.this, "Delete", Toast.LENGTH_SHORT).show();
                    return true;
                case R.id.action_report:
                    Toast.makeText(PostDetailsActivity.this, "Report", Toast.LENGTH_SHORT).show();
                    return true;
            }
            return false;
        }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (videoWidth > 0 && videoHeight > 0)
            surfaceView.adjustSize(ViewUtils.getDeviceWidth(this), ViewUtils.getDeviceHeight(this),
