...
//                                                            + " : " + response.body().getMessage());
    ...
    public class RequestsViewHolder extends RecyclerView.ViewHolder {
        ...
        ProximaNovaSemiboldButton action;
        @BindView(R.id.notification_decline)
...
//                            .into(holder2.dp);
//
//                holder2.content.setText(getString(getHighlights(holder2.notification.getHighlights()),
//                        holder2.notification.getMessage()));
//                holder2.isActiond = notificationsList.getNotifications().get(position).isActioned();
//                holder2.accountType = notificationsList.getNotifications().get(position).getAccountType();
//
//                if (holder2.isActiond == false) {
//
//                    if (holder2.notification.getNotificationType() == STARTED_FOLLOWING) {
//                        if (false) {
//
//                            holder2.action.setText("Accept");
//                            holder2.action.setTextColor(Color.parseColor("#546E7A"));
//                            holder2.action.setBackgroundResource(R.drawable.bg_outline_rounded_primary);
//                        }
//                        else
//                            holder2.action.setVisibility(View.GONE);
//
//                    }
//                    else if (holder2.notification.getNotificationType() == SENT_YOU_A_FOLLOW_REQUEST) {
//                        if (true) {
//                            holder2.action.setText("Accept");
//                            holder2.action.setTextColor(Color.parseColor("#546E7A"));
//                            holder2.action.setBackgroundResource(R.drawable.bg_outline_rounded_primary);
...
//
//                    }
//                    else if (holder2.notification.getNotificationType() == ACCEPTED_REQUEST) {
//
//                        if (holder2.notification.isFollowing()) {
//                            holder2.action.setText("Following");
//                            holder2.action.setTextColor(Color.parseColor("#546E7A"));
//                            holder2.action.setBackgroundResource(R.drawable.bg_outline_rounded_primary);
//                            holder2.action.setCompoundDrawablesWithIntrinsicBounds(context.getDrawable(R.drawable.ic_check_small),
//                                    null, null, null);
...
//                        }
//                    }
//                    else if (holder2.notification.getNotificationType() == ALSO_STARTED_FOLLOWING) {
//
//                        if (holder2.notification.isFollowing()) {
//                            holder2.action.setText("Following");
//                            holder2.action.setTextColor(Color.parseColor("#546E7A"));
...
//                        holder2.action.setCompoundDrawablesWithIntrinsicBounds(context.getDrawable(R.drawable.ic_check_small),
//                                null, null, null);
//                        if (holder2.declineRequest != null)
//                            holder2.declineRequest.setVisibility(View.GONE);
//
//                    } else {
//
//                        if (holder2.notification.isRequest_sent()) {
//                            if (holder2.notification.getAccountType() == 1) {
//                                holder2.action.setText("Requested");
//                                holder2.action.setTextColor(Color.parseColor("#546E7A"));
//                                holder2.action.setBackgroundResource(R.drawable.bg_outline_rounded_primary);
//                                if (holder2.declineRequest != null)
