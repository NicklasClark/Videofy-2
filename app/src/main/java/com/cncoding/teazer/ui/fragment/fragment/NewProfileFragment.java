...
public class NewProfileFragment extends BaseFragment implements AppBarLayout.OnOffsetChangedListener {
    ...
    // CircularAppCompatImageView imagedp;
...
//    RelativeLayout mainlayout;
    ...
    private ProfileFragment.FollowerListListener mListener;
...
//        });
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof ProfileFragment.FollowerListListener) {
            mListener = (ProfileFragment.FollowerListListener) context;
        }
    }
