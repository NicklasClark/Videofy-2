package com.cncoding.teazer.ui.customviews.coachMark;
...
public class MaterialShowcaseSequence implements IDetachedListener {
    ...
    BaseBottomBarActivity mActivity;
    ...
    public MaterialShowcaseSequence(BaseBottomBarActivity activity) {
        mActivity = activity;
        mShowcaseQueue = new LinkedList<>();
    }

    public MaterialShowcaseSequence(BaseBottomBarActivity activity, String sequenceID) {
        this(activity);
