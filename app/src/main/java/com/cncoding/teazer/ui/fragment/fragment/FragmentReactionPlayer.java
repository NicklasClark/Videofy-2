                ...
                try {
                    ...
                    if (othersPostDetails != null) {
                        ...
                        if(isGif) {
                            ...
                            if(othersPostDetails.getMediaDetail().getMediaType() == MEDIA_TYPE_GIFHY)
                            {
                                Gson gson = new Gson();
                                ...
                                Glide.with(this)
                                        .load(othersPostDetails.getMediaDetail().getMediaUrl())
                                        .apply(new RequestOptions().diskCacheStrategy(DiskCacheStrategy.RESOURCE))
                                        .into(gifView);
                            }
                        }
                    ...
                    if (selfPostDetails != null) {
                        ...
                        if (selfPostDetails != null) {
                            ...
                            if (isGif) {
                                ...
                                if (selfPostDetails.getMediaDetail().getMediaType() == MEDIA_TYPE_GIFHY) {
                                    Gson gson = new Gson();
