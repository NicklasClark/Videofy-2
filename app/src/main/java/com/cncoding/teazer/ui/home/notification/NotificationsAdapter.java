package com.cncoding.teazer.ui.home.notification;
                ...
                View.OnClickListener postListener = new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (holder1.notification.getNotificationType() == LIKED_YOUR_VIDEO ||
                            ...
                            ApiCallingService.Posts.getPostDetails(holder1.notification.getMetaData().getSourceId(), fragment.getTheContext())
                                    .enqueue(new Callback<PostDetails>() {
                                        ...
                                        public void onResponse(Call<PostDetails> call, Response<PostDetails> response) {
                                            if (response.code() == 200)
                                                ...
                                                Toast.makeText(fragment.getTheContext(), "Error fetching post", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                        ...
                                        public void onFailure(Call<PostDetails> call, Throwable t) {
                                            t.printStackTrace();
                                            Toast.makeText(fragment.getTheContext(), "Something went wrong", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                        }
                            ...
                            if(holder1.notification.getMetaData().getPostId()!=0) {
                                ApiCallingService.React.getReactionDetail2(holder1.notification.getMetaData().getSourceId(), fragment.getTheContext())
                                            ...
                                            public void onResponse(Call<ReactVideoDetailsResponse> call, Response<ReactVideoDetailsResponse> response) {
                                                if (response.code() == 200) {
                                                    if (response.body() != null) {
                                                        ...
                                                        Toast.makeText(fragment.getTheContext(), "Either post is not available or deleted by owner", Toast.LENGTH_SHORT).show();
                                                    }
                                                } else
                        ...
                        switch (view.getId()) {
                            ...
                            case R.id.action:
                                ...
                                if (text.equals(fragment.getString(R.string.follow))) {
                                    ApiCallingService.Friends.acceptJoinRequest(holder2.notification.getNotificationId(), fragment.getTheContext())
...
//                                    USER IS ACCEPTING A FOLLOW REQUEST
                                    ...
                                    AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(fragment.getTheContext());
                                    ...
                                    positiveButton.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            ApiCallingService.Friends.unfollowUser(holder2.notification.getMetaData().getSourceId(),
                                                    fragment.getTheContext()).enqueue(new Callback<ResultObject>() {
                                                @Override
                                                public void onResponse(Call<ResultObject> call, Response<ResultObject> response) {
                                                    if (response.code() == 200) {
                                                        if (response.body().getStatus()) {
                                    ...
                                    new AlertDialog.Builder(fragment.getTheContext())
                            ...
                            case R.id.decline:
                                ApiCallingService.Friends.deleteJoinRequest(holder2.notification.getNotificationId(), fragment.getTheContext())
                                        .enqueue(new Callback<ResultObject>() {
                                            @Override
                                            public void onResponse(Call<ResultObject> call, Response<ResultObject> response) {
                                                if (response.code() == 200) {
...
//                                                            + " : " + response.message());
    ...
    private void sendJoinRequest(final RequestsViewHolder holder) {
        ApiCallingService.Friends.sendJoinRequestByUserId(holder.notification.getMetaData().getSourceId(), fragment.getTheContext())
                .enqueue(new Callback<ResultObject>() {
                    @Override
                    public void onResponse(Call<ResultObject> call, Response<ResultObject> response) {
                        if (response.code() == 200) {
    ...
    private SpannableString getString(String boldText, String normalText) {
        ...
        string.setSpan(new StyleSpan(new TypeFactory(fragment.getTheContext()).bold.getStyle()), 0, boldText.length(), SPAN_EXCLUSIVE_EXCLUSIVE);
        return string;
    }
