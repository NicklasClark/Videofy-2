 ...
 */
package com.cncoding.teazer.customViews.exoplayer;
...
import com.cncoding.teazer.customViews.exoplayer.AspectRatioFrameLayout.ResizeMode;
 ...
 *       <ul>
 *         <li>Corresponding method: None</li>
 *         <li>Default: {@code R.id.custom_exo_player_view}</li>
 *       </ul>
 ...
 * configurations, you can define {@code custom_exo_player_view.xml} layout files in your
 ...
 * Defining your own {@code custom_exo_player_view.xml} is useful to customize the layout of
 ...
 * of {@code custom_exo_player_view.xml} for only the instance on which the attribute is set.
 */
...
//            overlayFrameLayout = null;
        ...
        int shutterColor = 0;
        int playerLayoutId = R.layout.custom_exo_player_view;
...
//                        defaultArtworkId);
                useController = a.getBoolean(R.styleable.SimpleExoPlayerView_use_controller, false);
