...
public class SemiboldButtonWithStartDrawable extends AppCompatButton {
    private Bitmap mIcon;
    private Paint mPaint;
    private Rect mSrcRect;
    private int mIconPadding;
    private int mIconSize;
    public SemiboldButtonWithStartDrawable(Context context) {
        super(context);
        applyCustomFont(context);
    }

    public SemiboldButtonWithStartDrawable(Context context, AttributeSet attrs) {
        super(context, attrs);
        applyCustomFont(context);
    ...
    public SemiboldButtonWithStartDrawable(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIcon != null) {
            ...
            @SuppressLint("DrawAllocation") Rect destRect = new Rect(left, top, left + mIconSize, top + mIconSize);
